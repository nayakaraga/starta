...
>
  <head>
    @section('head')
                                                                                                                                                                        ...
                                                                                                                                                                        <!-- Favicon -->
                                                                                                                                                                        <link rel="icon" type="image/x-icon" href="{{ URL::asset('img/favicon/favicon.ico') }}" />
                                                                                                                                                                        ...
                                                                                                                                                                        <!-- Core CSS -->
                                                                                                                                                                        <link rel="stylesheet"  href="{{ URL::asset('vendor/css/core.css') }}" />
                                                                                                                                                                        <link rel="stylesheet"  href="{{ URL::asset('vendor/css/theme-default.css') }}" />
                                                                                                                                                                        ...
                                                                                                                                                                        <!-- Page CSS -->
                                                                                                                                                                        <!-- Page -->
                                                                                                                                                                        <link rel="stylesheet" href="{{ URL::asset('vendor/css/pages/page-auth.css') }}" />
                                                                                                                                                                        <!-- Helpers -->
  ...
  <body>
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="index.html" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bolder ms-2">Starta</span>
            </a>
                                                                                                                                                                            ...
                                                                                                                                                                            <footer class="content-footer footer bg-footer-theme">
                                                                                                                                                                              <div class="container-xxl d-flex flex-wrap justify-content-between py-2 flex-md-row flex-column">
                                                                                                                                                                                <div class="mb-2 mb-md-0">
                                                                                                                                                                                  ...
                                                                                                                                                                                  , made with ❤️ by
                                                                                                                                                                                  <a href="https://saener.gy" target="_blank" class="footer-link fw-bolder">Kawan Kreatif</a>
                                                                                                                                                                                </div>
                                                                                                                                                                              </div>
                                                                                                                                                                            </footer>
            @show
    ...
    @section('plugins')
                                        ...
                                        <script src="{{ URL::asset('js/ui-toasts.js') }}"></script>
