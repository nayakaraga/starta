                    ...
                    <div class="card-body">
                        ...
                        <div class="app-brand justify-content-center">
                            <a href="index.html" class="app-brand-link gap-2">
                                ...
                                <span class="app-brand-text demo text-body fw-bolder">Starta</span>
                            </a>
                        </div>
                        <!-- /Logo -->
                        <h4 class="mb-2">Welcome to Starta! 👋</h4>
                        <p class="mb-4">Please sign-in to your account and start the adventure</p>

                        <form id="formAuthentication" class="needs-validation mb-3" novalidate="" action="/login"
                            method="post">

                            @if (session()->has('error'))
                                <div class="alert alert-danger alert-dismissible" role="alert">
                                    Woowowo holdup, something should be wrong!
